...
def get_best_wallets_for_token(token_address, token_name, max_best_addresses, max_transactions_to_check, start_time=None, end_time=None):
    WriterService.write_header_wallets_stats(token_name)
    all_transactions = EthTrackerService.get_transaction_of_token(token_address, token_name, max_transactions_to_check, start_time, end_time)
